package de.lotoos.inventory.common.items;

import de.lotoos.inventory.common.util.Duple;
...
public abstract class LanguageItemData implements ItemData {
    ...
    public ItemStack build() {
        ...
        if (itemMeta instanceof Damageable damageable) {damageable.setDamage(this.damage);}
